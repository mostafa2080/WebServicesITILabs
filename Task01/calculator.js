...
var myService = {
    MyService: {
        MyPort: {
            Add: ({ intA, intB, intC, intD, intE }) => ({ AddResult: add(intA, intB, intC, intD, intE) }),
            Subtract: ({intA, intB, intC, intD, intE }) => ({ SubtractResult: subtract(intA, intB, intC, intD, intE) }),
            Multiply: ({ intA, intB, intC, intD, intE }) => ({ MultiplyResult: multiply(intA, intB, intC, intD, intE) }),
            Divide: ({ intA, intB, intC, intD, intE }) => ({ DivideResult: divide(intA, intB, intC, intD, intE) }),
        }
    }
};
